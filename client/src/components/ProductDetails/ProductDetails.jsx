...
function ProductDetails({product, addToCart}) {
    ...
    const [imgSizeSmall, setImgSizeSmall] = useState(true);

    const toggleImgSize = () => {
        setImgSizeSmall(!imgSizeSmall);
    }
    ...
    <>
        <div>
            <Row className="container-main-details">
                <Col sm={3} md={3} lg={4}>
                    <Card className={ imgSizeSmall ? " img-card img-card-small" : "img-card img-card-big" } onClick={toggleImgSize}>
                        ...
                        <Card.Body className="desc-card-body">
                            <ListGroup variant="flush" >
                                ...
                                <ListGroup.Item>
                                    ...
                                    <div className='d-grid my-4 px-4'>
                                        <Button onClick={() => {}} variant="success" className=" mt-0.5 py-2">Add to Wishlist</Button>
                                    </div>
                            </ListGroup>
                        </Card.Body>
                    </Card>
