import { ADD_TO_CART, REMOVE_FROM_CART, CLEAR_CART, USER_SIGNIN, USER_SIGNOUT, SAVE_SHIPPING_ADDRESS, SAVE_PAYMENT_METHOD } from './Actions';

//Reducer used to update the states of cart and userInfo objects
